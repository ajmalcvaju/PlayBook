...
router.post("/resend-otp",turfController.resendOtp)
router.post("/login",turfController.login)
router.post("/forgot-password",turfController.forgotPassword)
router.post("/change-forgotpassword",turfController.changeForgottedPassword)
router.post("/verify-otp-forgotpassword",turfController.verifyOtpForgotPassword)
