  ...
  return (
    <>
      {isModalOpen && selectedBooking && (
        <div className="fixed inset-0 bg-gradient-to-br from-black via-gray-800 to-gray-900 bg-opacity-75 flex items-center justify-center transition-opacity duration-300 z-50">
